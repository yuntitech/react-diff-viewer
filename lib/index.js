...
var DiffViewer = /** @class */ (function (_super) {
    ...
    function DiffViewer(props) {
        ...
        _this.leftBlockLineNumberMap = new Map();
        /**
        ...
        _this.onBlockExpand = function (id) {
            ...
            _this.setState({
                ...
                _this.props.onBlockClick && _this.props.onBlockClick(true);
            });
        };
        _this.onBlockCollapse = function (id) {
            ...
            if (expandedBlocks.length > 0) {
                _this.setState({
                    ...
                    _this.props.onBlockClick && _this.props.onBlockClick(false);
                });
            }
        };
        /**
        ...
        _this.renderLine = function (lineNumber, type, prefix, value, additionalLineNumber, additionalPrefix, isRightEmpty, commitMap, authorMinW) {
            ...
            return (React.createElement(React.Fragment, null,
                !_this.props.hideLineNumbers && (React.createElement("td", { onClick: lineNumber && _this.onLineNumberClickProxy(lineNumberTemplate), className: classnames_1.default(_this.styles.gutter, (_a = {},
                        ...
                        _a)) }, _this.renderAuthor({ lineNumber: lineNumber, prefix: prefix, added: added, removed: removed, isRightEmpty: isRightEmpty, commitMap: commitMap, authorMinW: authorMinW }))),
        ...
        _this.onBlockClickProxy = function (params) { return function () {
            var isCollapse = params.isCollapse, id = params.id, leftBlockLineNumber = params.leftBlockLineNumber, num = params.num;
            if (isCollapse) {
                _this.onBlockCollapse(id);
                _this.leftBlockLineNumberMap.delete(leftBlockLineNumber);
            }
            else {
                _this.onBlockExpand(id);
                _this.leftBlockLineNumberMap.set(leftBlockLineNumber, num);
            }
        }; };
        /**
        ...
        _this.renderSkippedLineIndicator = function (num, blockNumber, leftBlockLineNumber, rightBlockLineNumber, showCollapse) {
            ...
            var operateText = showCollapse ? 'Collapse' : 'Expand';
            var message = _this.props.codeFoldMessageRenderer ? (_this.props.codeFoldMessageRenderer(num, leftBlockLineNumber, rightBlockLineNumber)) : (React.createElement("pre", { className: _this.styles.codeFoldContent }, operateText + " " + num + " lines ..."));
            var content = (React.createElement("td", null,
                React.createElement("a", { onClick: _this.onBlockClickProxy({
                        id: blockNumber,
                        isCollapse: showCollapse,
                        leftBlockLineNumber: leftBlockLineNumber,
                        num: num,
                    }), tabIndex: 0 }, message)));
        ...
        _this.renderDiff = function () {
            ...
            var authorMinW = diffLines[diffLines.length - 1] >= 1000 ? 60 : 52;
            ...
            return lineInformation.map(function (line, i) {
                ...
                var diffNodes = splitView
                    ? _this.renderSplitView(line, i, commitMap, authorMinW)
                    : _this.renderInlineView(line, i, commitMap, authorMinW);
                var showCollapse = _this.leftBlockLineNumberMap.has(line.left.lineNumber);
                if ((currentPosition === extraLines && skippedLines.length > 0) || showCollapse) {
                    var length_1 = skippedLines.length;
                    skippedLines = [];
                    if (showCollapse) {
                        length_1 = _this.leftBlockLineNumberMap.get(line.left.lineNumber);
                    }
